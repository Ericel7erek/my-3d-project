    ...
    <group {...props} dispose={null}>
        <group scale={0.01} >
            ...
            <ColoredMesh geometry={nodes.Cube_4.geometry} material={nodes.Cube_4.material} position={[-30.168, -83.071, 168.162]} rotation={[1.672, 0, -0.403]} scale={0.797} />
            <ColoredMesh geometry={nodes.Cube_3.geometry} material={nodes.Cube_3.material} position={[-17.231, 215.121, -8.87]} rotation={[0, 0, 0.383]} scale={0.928} />
            <ColoredMesh geometry={nodes.Cube_2.geometry} material={nodes.Cube_2.material} position={[-69.746, 208.695, -8.87]} rotation={[0, 0, -0.175]} scale={0.928} />
            </group>
        </group>
        </group>		
        )
